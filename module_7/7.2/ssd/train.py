...
parser.add_argument('--data_folder', default='./', type=str,
                    help='каталог с *_images.json и *_objects.json')
parser.add_argument('--label_map',    default='./utils_bccd.py', type=str)
...
iterations = 2000  # number of iterations to train
...
grad_clip = 2.0  # clip if gradients are exploding, which may happen at larger batch sizes (sometimes at 32) - you will recognize it by a sorting error in the MuliBox loss calculation
...
def main():
    ...
    for epoch in range(start_epoch, epochs):
        ...
        # Save checkpoint
        save_checkpoint(epoch, model, optimizer, filename=args.checkpoint)
